        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Product_SellingPrice", "[SellingPrice] >= [PurchasePrice]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_Tenants_TenantId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InsightLogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiInsightLogs", x => x.InsightLogId);
                    table.ForeignKey(
                        name: "FK_AiInsightLogs_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "TenantId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AiInsightLogs_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerInteractions_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "TenantId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerInteractions_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OcrResultId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OcrExtractionResults", x => x.OcrResultId);
                    table.ForeignKey(
                        name: "FK_OcrExtractionResults_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "TenantId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OcrExtractionResults_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Quotations_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryMovements_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrderItem_Quantity", "[Quantity] > 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_QuotationItem_Quantity", "[Quantity] > 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuotationItems_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sales_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleItems_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "TenantId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiInsightLogs_CreatedBy",
                table: "AiInsightLogs",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_AiInsightLogs_TenantId_CreatedAt",
                table: "AiInsightLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractions_TenantId",
                table: "CustomerInteractions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractions_TenantId1",
                table: "CustomerInteractions",
                column: "TenantId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMovements_TenantId1",
                table: "InventoryMovements",
                column: "TenantId1");

            migrationBuilder.CreateIndex(
                name: "IX_OcrExtractionResults_CreatedBy",
                table: "OcrExtractionResults",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_OcrExtractionResults_TenantId_CreatedAt",
                table: "OcrExtractionResults",
                columns: new[] { "TenantId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductCode_TenantId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_TenantId1",
                table: "PurchaseOrderItems",
                column: "TenantId1");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_PONumber_TenantId",
                table: "PurchaseOrders",
                columns: new[] { "PONumber", "TenantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_TenantId1",
                table: "PurchaseOrders",
                column: "TenantId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuotationItems_TenantId1",
                table: "QuotationItems",
                column: "TenantId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotations_QuotationNumber_TenantId",
                table: "Quotations",
                columns: new[] { "QuotationNumber", "TenantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_InvoiceNumber_TenantId",
                table: "Sales",
                columns: new[] { "InvoiceNumber", "TenantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sales_IsPaid",
                table: "Sales",
                column: "IsPaid");
